...
export default{
    ...
    methods:{
        ...
        paginationPro(page){
            ...
            this.$store.dispatch('offerProducts',this.pagePar).then(response => {
        ...
        paginationFilterPro(page){
            ...
            this.$store.dispatch('offerFilterProducts',this.filterForm).then(response => {
                this.products = response.data;
                this.defaultd = false;
            })
            .catch(error => {
        ...
        getFilters(){
            this.$store.dispatch('offerFilter',this.pagePar.offer_id).then(response => {
            ...
            this.filterForm.offer_id = this.$route.params.offer_id;
