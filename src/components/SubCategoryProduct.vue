            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><router-link :to="/type-products/+[filterForm.type_slug+'/'+filterForm.type_id]" class="text-decoration-none text-capitalize">{{ typeName }}</router-link></li>
                        <li class="breadcrumb-item "><router-link :to="/category-products/+[filterForm.type_slug+'/'+filterForm.type_id+'/'+filterForm.category_slug+'/'+filterForm.category_id]" class="text-decoration-none text-capitalize">{{ categoryName }}</router-link></li>
                        <li class="breadcrumb-item "><a href="#" class="text-decoration-none text-capitalize">{{ subCategoryName }}</a></li>
                    </ol>
                </nav>
            </div>
...
export default{
    ...
    data(){
        return{
            ...
            filterForm: {
                ...
                limit: '20',
                type_slug: this.$route.params.type_slug,
    ...
    methods:{
        ...
        paginationPro(page){
            ...
            this.$store.dispatch('subCategoryProducts',this.pagePar).then(response => {
        ...
        paginationFilterPro(page){
            ...
            this.$store.dispatch('subCategoryFilterProducts',this.filterForm).then(response => {
                this.products = response.data;
                this.defaultd = false;
            })
            .catch(error => {
        ...
        getProducts(){
            ...
            this.$store.dispatch('subCategoryProducts',this.pagePar).then(response => {
                this.products = response.data;
                this.typeName = this.$route.params.type_slug.replace(/-/g,' ');                
                this.categoryName = this.$route.params.category_slug.replace(/-/g,' ');                
                this.subCategoryName = this.$route.params.subcategory_slug.replace(/-/g,' ');                
            })
            .catch(error => {
                console.log(error);
            });            
        ...
        getFilters(){
            var fildata = {
                'type_id': this.pagePar.type_id,
                'category_id': this.pagePar.category_id,
                'subcategory_id': this.pagePar.subcategory_id,
            };
            this.$store.dispatch('subCategoryFilter',fildata).then(response => {
            ...
            this.filterForm.category_id = this.$route.params.category_id;
            this.filterForm.subcategory_id = this.$route.params.subcategory_id;
