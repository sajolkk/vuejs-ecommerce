            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="#" class="text-decoration-none text-capitalize">{{ brandName }}</a></li>
                    </ol>
                </nav>
            </div>
...
export default{
    ...
    methods:{
        ...
        paginationPro(page){
            ...
            this.$store.dispatch('brandProducts',this.pagePar).then(response => {
        ...
        paginationFilterPro(page){
            ...
            this.$store.dispatch('brandFilterProducts',this.filterForm).then(response => {
                this.products = response.data;
                this.defaultd = false;
            })
            .catch(error => {
        ...
        getProducts(){
            ...
            this.$store.dispatch('brandProducts',this.pagePar).then(response => {
                this.products = response.data;
                this.brandName = this.$route.params.slug.replace(/-/g,' ');                
            })
            .catch(error => {
                console.log(error);
            });            
        ...
        getFilters(){
            this.$store.dispatch('brandFilter',this.pagePar.brand_id).then(response => {
            ...
            this.filterForm.brand_id = this.$route.params.brand_id;
