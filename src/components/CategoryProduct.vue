            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="#" class="text-decoration-none text-capitalize">{{ categoryName }}</a></li>
                    </ol>
                </nav>
            </div>
...
export default{
    ...
    methods:{
        ...
        paginationPro(page){
            ...
            this.$store.dispatch('categoryProducts',this.pagePar).then(response => {
        ...
        paginationFilterPro(page){
            ...
            this.$store.dispatch('categoryFilterProducts',this.filterForm).then(response => {
                this.products = response.data;
                this.defaultd = false;
            })
            .catch(error => {
        ...
        getFilters(){
            ...
            this.$store.dispatch('categoryFilter',fildata).then(response => {
